...
export function IconCart({ fill, width, height, className }: any, props: any) {
  return (
    <svg
      width={width ?? "24"}
      height={height ?? "24"}
...
export function IconEmail({ fill, width, height, className }: any, props: any) {
  return (
    <svg
      fill={fill}
      width={width ?? "24"}
...
export function IconAbout({ fill, width, height, className }: any, props: any) {
  return (
    <svg
      fill={fill}
      width={width ?? "24"}
